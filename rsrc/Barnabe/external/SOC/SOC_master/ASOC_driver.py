...
if (1): # THE ASOC RUNS
    ...
    print("================================================================================")
    if (1):
        os.system('python3 ../SOC/SOC_master/ASOC.py rt_simple.ini')
    else:
        print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
...
os.system('../SOC/SOC_master/A2E_MABU.py %s %s %s %s' % (INI, fabs, femit, args))
...
print("================================================================================")
os.system('../SOC/SOC_master/ASOC.py maps.ini')
